        ...
        <ul className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row absolute md:static top-[60px] left-0 w-full md:w-auto bg-[#030303] items-center gap-8 py-8 md:py-0 border-b md:border-none border-gray-800`}>
          ...
          <li>
            ...
            <Link
               to="/contact"
               onClick={closeMenu}
               className="px-6 py-2 bg-transparent border-2 border-cyan-500 text-cyan-500 text-sm font-bold uppercase rounded hover:bg-cyan-500 hover:text-white transition-all shadow-[0_0_15px_rgba(34,211,238,0.3)] hover:shadow-[0_0_25px_rgba(34,211,238,0.6)]"
            >Contact </Link>
          </li>
        </ul>
      </div>
